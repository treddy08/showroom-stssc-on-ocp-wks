...
= Optional Challenge Lab: Resolving the Deployment File Warning
...
. Using the terminal and the git clone command, clone the project {git_project}
. Navigate to the *kustomize* base folder of the globex application and identify the *globex-ui* deployment file
