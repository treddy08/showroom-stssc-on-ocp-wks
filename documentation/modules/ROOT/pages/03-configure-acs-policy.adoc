...
. Go to the {rhacs_console_url}[RHACS Console,window=read-later] and log in with your credentials username: *{acs_portal_username}* and password: *{acs_portal_password}*.
